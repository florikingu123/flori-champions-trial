...
<head>
    ...
    <title><?= $page_title ?? 'VolunteerHub' ?></title>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            <a href="index.php" class="logo d-flex align-items-center">
                <img src="assets/img/Fambara/logo.png" alt="VolunteerHub Logo" class="me-2">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <li><a href="#">Your Hours: <?= htmlspecialchars($_SESSION['points'] ?? 0) ?></a></li>
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-about">
                    <a href="index.php" class="d-flex align-items-center">
                        <img src="assets/img/Fambara/logo1.png" alt="VolunteerHub Logo" class="footer-logo">
                    </a>
                ...
                <div class="col-lg-2 col-md-3 footer-links">
                    ...
                    <ul>
                        ...
                        <li><i class="bi bi-chevron-right"></i> <a href="portfolio.php">Portfolio</a></li>
